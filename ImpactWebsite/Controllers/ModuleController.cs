...
namespace ImpactWebsite.Controllers
{
    public class ModuleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ModuleId,ModuleName,DeliveryDays,Description,LongDescription,UnitPriceId")] Module orderModule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ModuleId,ModuleName,DeliveryDays,Description,LongDescription,UnitPriceId")] Module orderModule)
        {
